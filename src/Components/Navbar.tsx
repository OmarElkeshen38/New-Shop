...
const Navbar: FC = () => {
    ...
    // const handelSearch = (e: { target: { value: string } }) => {
    //     if (e.target.value === "") {
    //         router.push(`/`);
    //     } else {
    ...
    return (
        <header className="bg-cyan-700">
            <div className="navbar bg-cyan-700 bg-current container py-4">
                ...
                <div className="flex-none gap-2 text-cyan-100">
                        ...
                        >
                            <div className="card-body bg-cyan-400 rounded-md">
                                ...
                                <div className="card-actions">
                                    <button className="btn btn-block bg-cyan-900 text-cyan-200 hover:bg-cyan-200 hover:text-cyan-900">View cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
